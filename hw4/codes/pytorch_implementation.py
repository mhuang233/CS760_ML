...
# plt.savefig("hw4/figures/pytorch_learning_curve.png")
# plt.savefig("hww4/figures/init_zeros_learning_curve.png")
plt.savefig("hw4/figures/neg_one_one_learning_curve.png")
