...
q2 = pd.read_csv("hw2/codes/Q2.txt", sep=" ", header=None, names=["x1", "x2", "y"])
druns = pd.read_csv("hw2/codes/Druns.txt", sep=" ", header=None, names=["x1", "x2", "y"])
d3 = pd.read_csv("hw2/codes/D3leaves.txt", sep=" ", header=None, names=["x1", "x2", "y"])
d1 = pd.read_csv("hw2/codes/D1.txt", sep=" ", header=None, names=["x1", "x2", "y"])
d2 = pd.read_csv("hw2/codes/D2.txt", sep=" ", header=None, names=["x1", "x2", "y"])
